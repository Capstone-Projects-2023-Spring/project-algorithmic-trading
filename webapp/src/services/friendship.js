...
export async function findUserByUsername(username) {
  let response = await fetch(
    `${API_ENDPOINT}/friendship/find_user_by_username/?username=${username}`,
    {
      headers: {
...
export async function isFriendsWith(userId) {
  let response = await fetch(
    `${API_ENDPOINT}/friendship/check_friendship/?user_id=${userId}`,
    {
      headers: {
        "Content-Type": "application/json",
        authorization: `Bearer ${localStorage.getItem("access_token")}`,
...
export async function hasOutgoingRequest(userId) {
  let response = await fetch(
    `${API_ENDPOINT}/friendship/check_outgoing_request/?user_id=${userId}`,
    {
      headers: {
        "Content-Type": "application/json",
        authorization: `Bearer ${localStorage.getItem("access_token")}`,
...
export async function hasIncomingRequest(userId) {
  let response = await fetch(
    `${API_ENDPOINT}/friendship/check_incoming_request/?user_id=${userId}`,
    {
      headers: {
        "Content-Type": "application/json",
        authorization: `Bearer ${localStorage.getItem("access_token")}`,
...
export async function getFriendRequests() {
  let response = await fetch(
    `${API_ENDPOINT}/friendship/get_friend_requests/`,
    {
      headers: {
        "Content-Type": "application/json",
        authorization: `Bearer ${localStorage.getItem("access_token")}`,
