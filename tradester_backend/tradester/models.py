...
class Stock(models.Model):
    ...
    daily_high = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    daily_low = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    daily_num_transactions = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    daily_open_price = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    daily_volume = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    daily_vwap = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
