...
# Define the route that will be triggered when the user clicks the button
...
def generate_graph():
    ...
    # create a BytesIO object to save the plot to in memory
    output = BytesIO()
    fig.savefig(output, format='png')
    output.seek(0)

    # return the plot as a Flask response
